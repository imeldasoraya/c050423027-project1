...
@enderror" name="title" value="{{ old('title') }}" placeholder="Masukkan Judul Product">
...
@enderror" name="price" value="{{ old('price') }}" placeholder="Masukkan Harga
Product">
...
@enderror" name="stock" value="{{ old('stock') }}" placeholder="Masukkan Stock
Product">
...
<button type="submit" class="btn btn-md btn-primary me-
3">SAVE</button>
